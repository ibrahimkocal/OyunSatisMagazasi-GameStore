...
loginButton.addEventListener("click", function(){
    ...
    form.innerHTML = `<p class="title">Giriş Yap</p>
    <form class="form">
        ...
        <div class="input-group mt-3">
            ...
            <div class="forgot mt-3">
                <a rel="noopener noreferrer" href="#">Şifremi Unuttum ?</a>
            </div>
        </div>
        <button class="sign">Giriş Yap</button>
    </form>
    <div class="social-message mt-2">
        <div class="line"></div>
        <p class="message">Hesabın ile Giriş Yap</p>
        <div class="line"></div>
    </div>
    ...
    <p class="signup">Hesabın mı yok?
        <a rel="noopener noreferrer" href="" class="text-white ms-1">Kayıt Ol</a>
    </p>`
});
...
registerButton.addEventListener("click", function(){
    ...
    form.innerHTML = `<p class="title">Kayıt Ol</p>
    <form class="form">
        <div class="input-group">
            <label for="username">Kullanıcı Adı</label>
            <input type="text" name="username" id="username" placeholder="">
        ...
        <button class="sign mt-5">Kayıt Ol</button>
    </form>
    <div class="social-message mt-2">
        <div class="line"></div>
        <p class="message">Hesabın ile Kayıt Ol</p>
        <div class="line"></div>
    </div>
    <div class="social-icons">
        <button aria-label="Log in with Google" class="icon">
    ...
    <p class="signup">Hesabın mı var?
        <a rel="noopener noreferrer" href="" class="text-white ms-1">Giriş Yap</a>
    </p>`
});
...
signupLink.addEventListener("click", function (event) {
    ...
    } else if (registerButton.classList.contains("active")) {
        registerButton.classList.remove("active");
        loginButton.classList.add("active");
        form.innerHTML = `<p class="title">Giriş Yap</p>
    <form class="form">
